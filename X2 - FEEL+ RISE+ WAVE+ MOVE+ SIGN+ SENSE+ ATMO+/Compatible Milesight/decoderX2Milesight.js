...
function milesight(bytes) {
  var stringHex=bytesString(bytes)
  var octetTypeProduit = parseInt(stringHex.substring(0,2),16);
  var octetTypeMessage = parseInt(stringHex.substring(2,4),16);
  var data_decoded=dataOutput(octetTypeMessage,octetTypeProduit,stringHex)
  
  return {"decoded":data_decoded};
}
...
function bytesString(input)
{
	var bufferString=''
	var decToString=0;
	var replace_padStart =0;
	for(var i=0; i<input.length;i++)
    {
		decToString=parseInt(input[i],10).toString(16);
		replace_padStart=("00" + decToString).slice(-2);
		bufferString=bufferString+replace_padStart;		
	}
    return bufferString
}

function dataOutput(octetTypeMessage,octetTypeProduit,stringHex)
{
	switch(octetTypeMessage)
	{		
		case 1:
			data=periodicDataOutput(octetTypeMessage,octetTypeProduit,stringHex)
			return data;
		
		case 2:
			data=historicalCO2DataOutput(octetTypeMessage,octetTypeProduit,stringHex)
			return data
		
		case 3:
			data=historicalTemperatureDataOutput(octetTypeMessage,octetTypeProduit,stringHex)
			return data
		
		case 4:
		  data=historicalHumidityDataOutput(octetTypeMessage,octetTypeProduit,stringHex)
			return data
		
		case 5:
			data=productStatusDataOutput(octetTypeMessage,octetTypeProduit,stringHex)
			return data

        case 6:
			data=productConfigurationDataOutput(octetTypeMessage,octetTypeProduit,stringHex)
			return data

        case 7:
			data=productScreenConfigurationDataOutput(octetTypeMessage,octetTypeProduit,stringHex)
			return data

        case 8:
			data=presenceAlertDataOutput(octetTypeMessage,octetTypeProduit,stringHex)
			return data
    }
}
...
function periodicDataOutput(octetTypeMessage,octetTypeProduit,stringHex) {
...
function historicalCO2DataOutput(octetTypeMessage,octetTypeProduit,stringHex) {
    var mesure = [];
    var i = 0;
...
function historicalTemperatureDataOutput(octetTypeMessage,octetTypeProduit,stringHex) {
    var mesure = [];
    var i = 0;
    var data_nombre_mesures = (parseInt(stringHex.substring(4, 6), 16) >> 2) & 0x3F;
    var data_time_between_measurement_sec = ((parseInt(stringHex.substring(4, 8), 16) >> 2) & 0xFF);
...
function historicalHumidityDataOutput(octetTypeMessage,octetTypeProduit,stringHex) {
    var mesure = [];
    var i = 0;
    var data_nombre_mesures = (parseInt(stringHex.substring(4, 6), 16) >> 2) & 0x3F;
    var data_time_between_measurement_sec = ((parseInt(stringHex.substring(4, 8), 16) >> 2) & 0xFF);
...
function productStatusDataOutput(octetTypeMessage,octetTypeProduit,stringHex) {
...
function productConfigurationDataOutput(octetTypeMessage,octetTypeProduit,stringHex) {
...
function productScreenConfigurationDataOutput(octetTypeMessage,octetTypeProduit,stringHex) {
    var data_config_source = (parseInt(stringHex.substring(4, 5), 16) >> 1) & 0x07;
    var data_config_status = (parseInt(stringHex.substring(4, 6), 16) >> 3) & 0x03;
...
function presenceAlertDataOutput(octetTypeMessage,octetTypeProduit,stringHex) {
